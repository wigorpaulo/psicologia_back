...
export class TaxRegisterConfigurationsController {
  constructor(private readonly taxRegisterConfigurationsService: TaxRegisterConfigurationsService) {}

  @Post()
  create(@Body() createTaxRegisterConfigurationDto: CreateTaxRegisterConfigurationDto) {
    return this.taxRegisterConfigurationsService.create(createTaxRegisterConfigurationDto);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateTaxRegisterConfigurationDto: UpdateTaxRegisterConfigurationDto) {
    return this.taxRegisterConfigurationsService.update(+id, updateTaxRegisterConfigurationDto);
  }
